...
msalm = "↢ وسوينا لك حساب في بنك زوزة\n↢ وشحنالك ٥٠ درهم 💸 هديه\n\n↢ رقم حسابك ↤ ❲ `"..cccall.."` ❳\n↢ نوع البطاقة ↤ ❲ "..ccctype.." ❳\n↢ فلوسك ↤ ❲ 50 ريال 💸 ❳\n↢ شخصيتك ↤ "..shakseshakse.."\n↢ دولتك ↤ ❲ 🇸🇾 ❳"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
edit(ChatId,Msg_id,"↢ تم الغاء شراء اللاعب زوزة سواريز ", 'md', true)
end
end
...
if tonumber(data.sender_user_id) == tonumber(UserId) then
edit(ChatId,Msg_id,"↢ تم الغاء شراء اللاعب زوزة صلاح", 'md', true)
end
end
...
data = {
{
{text = 'زخرفة انجليزي | EN', data = IdUser..'/Zhrfaen'},
},
{
{text = 'زخرفة عربي | AR', data = IdUser..'/Zhrfaar'},
}
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
local DCBAN = Redis:get(TheMero..ChatId..IdUser.."zkrf:text")
